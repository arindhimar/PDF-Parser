"""
run_all.py – Batch-parse all PDFs in the Dummy_Resumes/ folder using PyMuPDF.
...
Prerequisites:
  • pip install -r requirements.txt
    (PyMuPDF natively includes all parsing capabilities, no system dependencies needed)
"""
